...
import { ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Globe } from 'lucide-react';
...
export const IngressNode = memo((props: NodeProps) => {
  ...
  return (
    <div className={cn(
      ...
      <Handle type="target" position={Position.Top} id="top-t" className="!bg-rose-500" />
      ...
      <Handle type="source" position={Position.Bottom} id="bottom-s" className="!bg-rose-500" />

      <Handle type="target" position={Position.Left} id="left-t" className="!bg-rose-500" />
      ...
      <Handle type="source" position={Position.Right} id="right-s" className="!bg-rose-500" />
    </div>
  );
});
