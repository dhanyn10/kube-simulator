...
export const HPANode = memo((props: NodeProps) => {
  ...
  return (
    <div className={cn(
      ...
      <Handle type="target" position={Position.Top} id="top-t" className="!bg-fuchsia-500" />
      ...
      <Handle type="source" position={Position.Bottom} id="bottom-s" className="!bg-fuchsia-500" />

      <Handle type="target" position={Position.Left} id="left-t" className="!bg-fuchsia-500" />
      <Handle type="source" position={Position.Left} id="left-s" className="!opacity-0" />

      <Handle type="target" position={Position.Right} id="right-t" className="!bg-fuchsia-500" />
      <Handle type="source" position={Position.Right} id="right-s" className="!bg-fuchsia-500" />
    </div>
  );
});
