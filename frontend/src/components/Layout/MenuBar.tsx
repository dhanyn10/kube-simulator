...
import { FileCode, Save, Upload, FolderOpen, BookOpen, Info, Bug, CheckSquare, Square, Activity, ExternalLink, Sun, Moon, Bell, PlayCircle, Sliders, Terminal, Download, ShieldCheck } from 'lucide-react';
    ...
    >
      <div className="flex items-center gap-1">
        <svg
          ...
          viewBox="0 0 512 512"
          className="w-4 h-4 mx-1 fill-current"
        >
        ...
        {/* K8s Active Identity Badge - Only visible if switched to a Kube IAM identity */}
        {activeIdentity && activeIdentity !== 'system:admin' && (
          <button
            type="button"
          ...
          >
            ...
            <span>User: <strong className="underline decoration-emerald-500/50">{activeIdentity}</strong></span>
          </button>
        )}
