        ...
        <div className={cn(
          ...
          <button
            ...
            className={cn(
              ...
              activeTab === 'view'
                ? (colorMode === 'dark' ? "bg-slate-800 text-blue-400" : "bg-white text-blue-600 shadow-sm border border-slate-200/50")
                : (colorMode === 'dark' ? "text-slate-400 hover:bg-slate-800/30 hover:text-slate-200" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900")
            )}
          >
            <Eye size={15} />
            <span>View</span>
